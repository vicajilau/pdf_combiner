...
abstract class PdfCombinerPlatform extends PlatformInterface {
  ...
  ///
  /// Returns:
  /// - A `Future<String>` representing the build information
  ...
  Future<String> buildDate() {
    throw UnimplementedError('buildDate() has not been implemented.');
  }

  /// Retrieves build date with time information.
  ///
  /// Platform-specific implementations should override this method to retrieve
  /// the build information from the native platform.
  ///
  ...
  Future<String> buildDateWithTime() {
    throw UnimplementedError('buildDateWithTime() has not been implemented.');
  }

  /// Retrieves version name information.
  ///
  /// Platform-specific implementations should override this method to retrieve
  /// the build information from the native platform.
  ///
  ...
  /// Retrieves version code information.
  ///
  /// Platform-specific implementations should override this method to retrieve
  /// the build information from the native platform.
  ///
  ...
  /// Retrieves package name information.
  ///
  /// Platform-specific implementations should override this method to retrieve
  /// the build information from the native platform.
  ///
  ...
  /// Retrieves app name information.
  ///
  /// Platform-specific implementations should override this method to retrieve
  /// the build information from the native platform.
  ///
